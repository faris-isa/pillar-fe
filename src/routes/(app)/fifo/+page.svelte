...
<div class="h-screen flex-col pt-5 pr-6 pb-6 pl-3">
    <div class="card-min h-full">
        ...
        <div class="h-[calc(100%-8rem)] overflow-auto">
            <div class="{removeMode ? "flex" : "hidden"} w-[calc(100%-2.5rem)] my-5 mx-5">
                ...
                <form action="?/fifoSubmit" method="post" use:enhance={({form, data}) => {
                    ...
                    <div class="w-full grid grid-cols-2 gap-4">
                        ...
                        <div class="flex items-baseline mb-5">
                            <button type="submit" class="mt-8 px-10 py-3 text-white bg-red-600 rounded-lg hover:bg-red-900">OUT !</button>
                        </div>
                    </div>
            ...
            <table class="w-[calc(100%-2.5rem)] text-center mx-5">
                <thead class="">
                    <tr class="border-2 border-black">
                        ...
                        <td class="pb-4 pt-4 bg-white sticky top-0">Action</td>
                    </tr>
                </thead>
                <tbody>
